...
description: "Commit, push, and open a PR with an adaptive, value-first description. Use for \"commit and PR\", \"ship this\", \"open a pull request\", or going from working changes to an open PR in one step. Also for \"update/refresh the PR description\" to rewrite an existing one. Description depth scales with change complexity."
---
